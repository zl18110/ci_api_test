    ...
    * 验证数据库返回值
      """
        [{
          ...
          'goods_imgs': '',
          'goods_original_price': Decimal('1111.00'),
          'discount': 0.0,
          'goods_num': 1,
          'goods_source_id': 7,
          'sale_group_id': 24,
